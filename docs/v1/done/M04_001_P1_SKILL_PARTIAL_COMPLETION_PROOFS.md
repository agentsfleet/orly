...
- > Indy (2026-08-22): "I want this change to go into the same PR" — context: spec-template determinism rework (TEMPLATE.md command-source rubric, spec-template.sh Family 2b + sentinels, lifecycle/write_spec/operating-model de-productisation, kishore-spec-new repo-local anchors) folded into PR #6.
