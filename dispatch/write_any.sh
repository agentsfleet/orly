...
# ERR's leaf hard-exits if the product repo's error registry is absent (it
...
dispatch_delegate "ERR" "make harness-verify (error-codes.sh — needs the product repo's error registry)"
